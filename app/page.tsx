      ...
      <Section id="services" eyebrow="Услуги" title="Как я помогаю" subtitle="Выберите формат под вашу задачу: от диагностики до полного ведения как внешний РОП.">
        <div className="grid md:grid-cols-2 gap-6">
          {[
            ...
            { icon: <Workflow className="h-6 w-6"/>, title: "Внедрение CRM и регламентов", text: "amoCRM/Bitrix24, воронки и статусы, unit‑экономика в сделке, отчёты и SLA 10–15 минут.", bullets: ["Дашборды «конверсии и сроки по этапам»","Онбординг, чек‑листы и шаблоны писем","Интеграции телефонии и мессенджеров"] }
